...
// Source: github.com/solrac97gr/go-test-tables/validator/domain/ports (interfaces: Validator)
...
import (
	...
	models "github.com/solrac97gr/go-test-tables/validator/domain/models"
)
...
func (m *MockValidator) Struct(arg0 models.EvaluableStruct) error {
	m.ctrl.T.Helper()
